...
public class LogCSVExportUtility {
    public static void main(String[] args) throws Exception {
        ...
        while (nextRecord.hasNext()) {
            ...
            FileUtils.writeStringToFile(new File(outDir, kubernetes_pod_name_s + ".log"), String.format("%s - %s [%s:%s@%s] - %s%n", timestamp_tdt, level_s, thread_s, logger_class_s, caller_line_number_s, message_txt), true);
        }
    }
}
